from utils import responses, validators, serializers
...
class ConfigsSerializer(serializers.ModelSerializer):
    ...
    def get_latest_nav(self, obj):
        ...
        from assistant._models import Transaction, FiscalYear
    ...
    def get_ordinary_unit_count(self, obj):
        ...
        from assistant._models import StorageType, FiscalYear
    ...
    def get_total_instruments(self, obj):
        from assistant._models import StorageType, FiscalYear, Transaction
